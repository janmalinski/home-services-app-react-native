...
export const AdCreateScreen = ({ navigation, route }: Props) => {
  ...
  const submitHandler = useCallback((values: AdFormData) => { 
    const { description, serviceIds, employmentTypeIds, dateAvailableFrom, fixedTerm, dateAvailableTo, setHoursWorkingTime, workingTime, address, latitude, longitude } = values;

   
    // dispatch(
    //   actions.createAdRequest(ą
    //     token,
    //     description,
    //     serviceIds,
    //     employmentTypeIds,
